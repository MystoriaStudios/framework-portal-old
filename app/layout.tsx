...
export default function RootLayout({
    ...
    return (
        ...
        >
            <body
                className={`${inter.className} transition-all ease-in-out min-h-screen flex flex-col bg-cover bg-neutral-100 dark:bg-neutral-900 dark:text-white`}>
            <Navbar>
                <SignedIn>
                    <span className="ml-2">
            ...
            <footer className="footer p-10 bg-neutral-950 text-base-content px-96">
                <aside>
                    ...
                    <p>Mystoria Studios Ltd.<br/>Providing reliable cloud systems.</p>
                </aside>
                <nav>
                    <header className="footer-title">Services</header>
                    <a className="link link-hover">Framework (this)</a>
