...
export default function RootLayout({
    ...
    // @ts-ignore
    return (
        <html lang="en" className="transition-colors delay-100 duration-200 ease-in-out">
        ...
        >
            ...
            <footer className="footer p-10 dark:bg-neutral-950 text-base-content px-96">
                <aside>
                    ...
                    <p className="mt-2">Mystoria Studios Ltd.<br/>Providing reliable cloud systems.</p>
                </aside>
                <nav>
